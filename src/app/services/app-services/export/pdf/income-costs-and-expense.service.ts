...
export class IncomeCostsAndExpenseService {
...
*/
  async generatePDF(data: any) {
    ...
    this.doc.text("INFORME INGRESOS, COSTOS Y GASTOS", 40, this.assignY(44));
  ...
  //   this.doc.text(25, this.assignY(15), splitTitle);
    ...
    this.doc.text(`        INGRESOS :                                           $ ${data.paymentValue.toLocaleString('nl-NL', { minimumFractionDigits: 2 })}      `, 14, this.positionY);
    /**
     * Linea Horizontal 2
     */
    this.doc.line(15, this.assignY(5), 195, this.positionY);
    ...
    */
    ...
    this.doc.setFontSize(14);
    this.doc.setFont("Helvetica", "bold")
    this.doc.text(`        GASTOS :                                               $ ${data.headquarterCostValue.toLocaleString('nl-NL', { minimumFractionDigits: 2 })}       `, 14, this.positionY);
    /**
     * Linea Horizontal
     */
    ...
    */
     ...
     * VAlor en caja
     */
    var val = (data.paymentValue - data.headquarterCostValue)
    this.doc.setLineWidth(1);
    //             x Y-arriba x   y-Abajo
    ...
    this.doc.setFontSize(14);
    this.doc.setFont("Helvetica", "bold")
    this.doc.text(`        En Caja:                                                  $ ${val.toLocaleString('nl-NL', { minimumFractionDigits: 2 })}      `, 14, this.positionY);
    /**
     * Linea Horizontal
     */
    this.doc.line(15, this.assignY(4), 195, this.positionY);
